...
//    UIImage * img=[[UIImage alloc] initWithData:data];
    [self.zerobutton   setImage:[UIImage imageNamed:@"0_up.png"] forState:UIControlStateNormal];
    [self.onebutton    setImage:[UIImage imageNamed:@"1_up.png"] forState:UIControlStateNormal];
    [self.twoButton    setImage:[UIImage imageNamed:@"2_up.png"] forState:UIControlStateNormal];
    [self.threeButton  setImage:[UIImage imageNamed:@"3_up.png"] forState:UIControlStateNormal];
    [self.fourButton   setImage:[UIImage imageNamed:@"4_up.png"] forState:UIControlStateNormal];
    [self.fiveButton   setImage:[UIImage imageNamed:@"5_up.png"] forState:UIControlStateNormal];
    [self.sixButton    setImage:[UIImage imageNamed:@"6_up.png"] forState:UIControlStateNormal];
    [self.sevenButton  setImage:[UIImage imageNamed:@"7_up.png"] forState:UIControlStateNormal];
    [self.eightButton  setImage:[UIImage imageNamed:@"8_up.png"] forState:UIControlStateNormal];
    [self.nineButton   setImage:[UIImage imageNamed:@"9_up.png"] forState:UIControlStateNormal];
    [self.deleteButton setImage:[UIImage imageNamed:@"qx_up.png"] forState:UIControlStateNormal];
    [self.cancelButton setImage:[UIImage imageNamed:@"x_up.png"] forState:UIControlStateNormal];
}
