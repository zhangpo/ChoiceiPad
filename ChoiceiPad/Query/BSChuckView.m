...
- (id)initWithFrame:(CGRect)frame withTag:(int)tag{
    ...
    if (self) {
        ...
        NSLog(@"%@",_aryReasons);
        if (tag!=3) {
            lblAcct = [[UILabel alloc] initWithFrame:CGRectMake(15, 60, 80, 40)];
            ...
            tfAcct = [[UITextField alloc] initWithFrame:CGRectMake(100, 60, 100, 40)];
            tfAcct.borderStyle = UITextBorderStyleRoundedRect;
            [self addSubview:tfAcct];
            
            lblPwd = [[UILabel alloc] initWithFrame:CGRectMake(210, 60, 90, 40)];
            ...
            tfPwd = [[UITextField alloc] initWithFrame:CGRectMake(310, 60, 100, 40)];
        ...
        {
            _lblcount = [[UILabel alloc] initWithFrame:CGRectMake(15, 105, 80, 40)];
            ...
            _tfcount = [[UITextField alloc] initWithFrame:CGRectMake(100, 105, 100, 40)];
            ...
            _lblfan = [[UILabel alloc] initWithFrame:CGRectMake(210, 105, 90, 40)];
            ...
            _tffan = [[UITextField alloc] initWithFrame:CGRectMake(310, 105, 100, 40)];
        ...
        pickerReason.backgroundColor=[UIColor clearColor];
